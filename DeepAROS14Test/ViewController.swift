...
//        buttonRecordingModePairs = [ (photoButton, RecordingMode.photo), (videoButton, RecordingMode.video), (lowQVideoButton, RecordingMode.lowQualityVideo)]
    ...
    private func setupDeepARAndCamera() {
        ...
        self.deepAR.setLicenseKey("36eec2de57bb1ef820565477f0dccec59dd43ea9e44f091e167f6698dc34e0e1dff9bfc7319dcf44")
        
        cameraController = CameraController()
        cameraController.deepAR = self.deepAR
        self.deepAR.videoRecordingWarmupEnabled = false;
        
        self.arView = self.deepAR.createARView(withFrame: self.view.frame)
        self.arView.translatesAutoresizingMaskIntoConstraints = false
        self.view.addSubview(self.arView)
        self.arView.leftAnchor.constraint(equalTo: self.view.leftAnchor, constant: 0).isActive = true
        self.arView.rightAnchor.constraint(equalTo: self.view.rightAnchor, constant: 0).isActive = true
        self.arView.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 0).isActive = true
        self.arView.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: 0).isActive = true
